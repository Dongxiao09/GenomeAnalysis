...
res2 <- results(dds, contrast=c("tis_type","MSK_ARIL","root"))
res3 <- results(dds, contrast=c("tis_type","MSK_ARIL","stem"))
res4 <- results(dds, contrast=c("tis_type","MSK_ARIL","leaf"))
res5 <- results(dds, contrast=c("tis_type","MT_ARIL","leaf"))
res6 <- results(dds, contrast=c("tis_type","MT_ARIL","stem"))
res7 <- results(dds, contrast=c("tis_type","MT_ARIL","root"))
res8 <- results(dds, contrast=c("tis_type","leaf","root"))
res9 <- results(dds, contrast=c("tis_type","stem","root"))
